...
import pandas as pd
from dagster import AssetIn, AssetOut, Output, asset, get_dagster_logger, multi_asset
...
from scraping_soccer.constants import dbt_manifest_path
...
def processing_matches_dbt(context: AssetExecutionContext, dbt: DbtCliResource):
